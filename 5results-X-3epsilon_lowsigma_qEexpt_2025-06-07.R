...
# save the simulation ----------------------------------------------------------------------------------
#save(epsilon,sigma,dpoint,Pload0,tstep,p0sim,p0.crit,nX,Pt,kh,kh.day,Acen,yhat,
#     ar1,sd1,modvar,tfore,Qmat,file='p0sim_EWS_eps3.Rdata')
# ------------------------------------------------------------------------------------------------------

# save the simulation ----------------------------------------------------------------------------------
#save(epsilon,sigma,dpoint,Pload0,tstep,kNCsim,kNC.crit,nX,Pt,kh,kh.day,Acen,yhat,
...
layout.show(nf)
#
load(file='qEsim_EWS_lowsig_eps0.3.Rdata')
# 1, Chl
...
#
# -------------------------------------------------------------------------------
load(file='qEsim_EWS_lowsig_eps1.Rdata')
# 1, Chl
plot(tstep,Pt,type='l',lwd=2,col='forestgreen',xlab='Day',
...
#
# -------------------------------------------------------------------------------
load(file='qEsim_EWS_lowsig_eps3.Rdata')
# 1, Chl
plot(tstep,Pt,type='l',lwd=2,col='forestgreen',xlab='Day',
