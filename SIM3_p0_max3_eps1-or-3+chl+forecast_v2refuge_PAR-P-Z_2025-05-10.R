...
epsilon = 1  # speed of p0 relative to Chl; try values from 0.1 to 4
print('',quote=F)
print(c('***********************************************************'),quote=F)
...
save(epsilon,sigma,dpoint,Pload0,tstep,p0sim,p0.crit,nX,Achl,kh,kh.day,Acen,yhat,
     ar1,sd1,modvar,tfore,Qmat,file='p0sim_EWS_eps1.Rdata')
# ------------------------------------------------------------------------------------------------------
